...
public class VectorClass {
    public static void main(String[] args) {
        ...
        list.add(new NameCard("우영우", "yyy@gmail.com", "010-1234-1234", "변호사"));
        list.add(new NameCard("동그라미", "circle@gmail.com", "010-1234-5678", "무직"));
        list.add(new NameCard("이준호", "ljh@gmail.com", "010-5678-1234", "회사원"));

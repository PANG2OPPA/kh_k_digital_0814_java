package 참조타입기초;
// 자바의 데이터 타입은 기본타입과 참조타입으로 나누어 집니다.
...
public class RefType {
    public static void main(String[] args) {
        ...
        //참조 타입 예제
        String name = "김현빈"; // String형으로 만들어진 name에는 실제 "김현빈"이라는 문자열이 없고 주소가 있음

//        int unbox = 0; // int형의 기본타입이므로 값을 대입하야 함

...
public class IPadPro {
    ...
    String name; // 각인서비스 시 이름저장
    String productDate; // 제픔 생산 일자
    ...
    void setMemory() {
        Scanner sc = new Scanner(System.in);
        while (true) {
            System.out.print("용량 선택 : [1] 125GB, [2] 256GB, [3] 512GB, [4] 1TB ");
            memory = sc.nextInt();
    ...
    void setName() {
        Scanner sc = new Scanner(System.in);
        System.out.print(" 각인서비스를 신청 하시겠습니까? (yes / no) ");
    ...
    void productPad() {
        ...
        final String[] coloeType = {"", "스페이스그레이", "실버"};
        final String[] memType = {"", "12GB", "256GB", "512GB", "1TB"};
        ...
        System.out.println("제품 색상 : " + coloeType[color]);
